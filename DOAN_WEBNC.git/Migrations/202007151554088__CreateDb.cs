    ...
    public partial class _CreateDb : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.NamHocs", t => new { t.IDNamHoc, t.TenHocKy }, cascadeDelete: true)
                .Index(t => new { t.IDNamHoc, t.TenHocKy })
                .Index(t => t.MaHocSinh)
                .Index(t => t.MaMonHoc);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.IDNamHoc, t.TenHocKy });
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DiemHS", new[] { "IDNamHoc", "TenHocKy" }, "dbo.NamHocs");
            ...
            DropIndex("dbo.DiemHS", new[] { "IDNamHoc", "TenHocKy" });
